...
<div className="bg-gradient-to-tr from-slate-600 via-indigo-700 to-slate-700 h-[85%] rounded">
    ...
    <div className="flex items-center gap-3">
        ...
        <div className="p-4 bg-gradient-to-tr from-slate-700 via-indigo-700 to-slate-800 m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4">
